        ...
        <>
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-20 max-w-lg mx-auto">
                        <Badge title="Innovative" />
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold font-heading text-center mt-6 !leading-tight">
                            Empower Your Neural Ops with AI Agents
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                            Revolutionize your operations with state-of-the-art AI agents designed to optimize and automate your neural processes.
                        </p>
                    ...
                    <div className="py-14">
                        <div className="mx-auto px-4 md:px-8">
                            <h2 className="text-center text-sm font-medium font-heading text-neutral-400 uppercase">
                                Trusted by Leaders in AI Innovation
                            </h2>
                            <div className="mt-8">
                    ...
                    <LampContainer className="max-w-2xl mx-auto">
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            ...
                            <p className="text-muted-foreground mt-6 max-w-lg mx-auto text-base md:text-lg">
                                Harness the power of AI for real-time insights and automation. Simplify processes and drive efficiency across your operations.
                            </p>
                            <div className="mt-6">
                                <Button asChild>
