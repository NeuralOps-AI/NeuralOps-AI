        ...
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Transform your operations with NeuralOps AI—where intelligent automation meets real-time insights. <span className="hidden sm:inline">Revolutionize your workflow with cutting-edge, AI-driven solutions.</span>
                </p>
            </Container>
            <Container delay={0.2}>
